...
Welcome to `fontlab_export_tools` contributor's guide.
...
If you experience bugs or general issues with `fontlab_export_tools`, please have a look
...
You can help improve `fontlab_export_tools` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`fontlab_export_tools` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `fontlab_export_tools`'s files. While this mechanism can
...
```
conda create -n fontlab_export_tools python=3 six virtualenv pytest pytest-cov
conda activate fontlab_export_tools
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/fontlab_export_tools.git
   cd fontlab_export_tools
   ```
...
5. Install [pre-commit]:
   ...
   `fontlab_export_tools` comes with a lot of hooks configured to automatically help the
